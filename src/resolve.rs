...
use crate::error::{IterDirError, PathError, ResolveError};
...
mod tests {
    ...
    async fn test_resolve() {
        ...
        assert!(matches!(err, Err(ResolveError::NotAbsolute)));
